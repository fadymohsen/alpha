      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="fixed inset-0 z-[100] bg-dark/95 backdrop-blur-2xl flex flex-col text-cream overflow-hidden"
          >
            ...
            {/* Header */}
            <div className="flex shrink-0 h-28 px-8 items-center justify-between relative z-10">
            ...
            <div className="p-10 shrink-0 border-t border-white/5 relative z-10 flex flex-col gap-6">
               <div className="flex items-center justify-between">
                  <Link href={switchHref} className="btn-secondary !bg-white/5 flex items-center gap-3">
                    <Globe size={20} className="text-accent" />
                    <span>{currentLocale === "ar" ? "English Version" : "النسخة العربية"}</span>
                  </Link>
               </div>
               <Link 
