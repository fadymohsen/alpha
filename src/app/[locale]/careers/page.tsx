    ...
    <main className="flex-grow pt-32 pb-24">
      <section className="bg-primary py-32 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 space-y-6">
          ...
          <p className="text-xl text-white/60 font-medium max-w-2xl mx-auto italic">{isRtl ? "ابنِ مستقبلك المهني مع رائد حلول النقل في المملكة" : "Build your career with the leader of transport solutions in the Kingdom"}</p>
        </div>
      </section>
