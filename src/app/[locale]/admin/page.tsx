...
import { Truck, Briefcase, HelpCircle, Settings, ImageIcon, Award } from "lucide-react";
...
const modules = [
  ...
  { icon: Award, label: { ar: "إدارة الشهادات", en: "Certificates" }, desc: { ar: "إضافة وتعديل الشهادات والاعتمادات", en: "Manage certificates and accreditations" }, href: "/certificates", color: "bg-purple-500" },
